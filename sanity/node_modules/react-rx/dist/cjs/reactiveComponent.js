...
function fromComponent(component) {
    var wrappedComponent = function (props) {
        return (0, react_1.createElement)(react_1.Fragment, null, (0, useObservable_1.useObservable)((0, react_1.useRef)(component((0, useAsObservable_1.useAsObservable)(props))).current));
    };
    wrappedComponent.displayName = (0, displayName_1.wrapDisplayName)(component, 'reactiveComponent');
    return wrappedComponent;
}
function fromObservable(input$) {
    return function ReactiveComponent() {
        return (0, react_1.createElement)(react_1.Fragment, null, (0, useObservable_1.useObservable)(input$));
    };
}
...
function forwardRef(component) {
    var wrappedComponent = (0, react_1.forwardRef)(function (props, ref) {
        return (0, react_1.createElement)(react_1.Fragment, null, (0, useObservable_1.useObservable)((0, react_1.useRef)(component((0, useAsObservable_1.useAsObservable)(props), ref)).current));
    });
    wrappedComponent.displayName = (0, displayName_1.wrapDisplayName)(component, 'reactiveComponent');
    return wrappedComponent;
}
