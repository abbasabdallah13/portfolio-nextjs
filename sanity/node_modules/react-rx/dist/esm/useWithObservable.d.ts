 ...
 * @param value
 */
export declare function useWithObservable<T>(value: T): T | undefined;
export declare function useWithObservable<T, K>(value: T, operator: (input: Observable<T>) => Observable<K>): K | undefined;
