...
exports.stringsToNumbers = stringsToNumbers;
...
function normalizeSearchConfigs(configs) {
  ...
  return configs.map(conf => {
    ...
    return {
      ...
      path: (0, _toPath2.default)(conf.path).map(stringsToNumbers),
      mapWith: typeof conf.mapWith === 'string' ? conf.mapWith : undefined
    };
  });
}
function stringsToNumbers(pathSegment) {
  var pathAsNumber = Number(pathSegment);
