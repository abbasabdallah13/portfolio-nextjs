...
function useRouterState() {
  ...
  var _useState = (0, _react.useState)(() => selector(getState())),
      ...
      setState = _useState2[1]; // reset the state when the `selector` prop changes


  (0, _react.useEffect)(() => setState(selector(getState())), [selector, getState]); // update the state via a subscription
