...
export declare type SearchOrderingReset = {
    type: 'SEARCH_ORDERING_RESET';
};
export declare type SearchOrderingSet = {
    ordering: SearchOrdering;
...
export declare type SearchAction = FiltersHide | FiltersShow | FiltersToggle | PageIncrement | RecentSearchesSet | SearchClear | SearchRequestComplete | SearchRequestError | SearchRequestStart | SearchOrderingReset | SearchOrderingSet | TermsQuerySet | TermsSet | TermsTypeAdd | TermsTypeRemove | TermsTypesClear;
