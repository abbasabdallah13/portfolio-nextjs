...
var _SortMenu = require("./SortMenu");
...
var SearchResultsFlex = (0, _styledComponents.default)(_ui.Flex)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  height: 100%;\n"])));
var SearchResultsInnerFlex = (0, _styledComponents.default)(_ui.Flex)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  opacity: ", ";\n  overflow: hidden;\n  position: relative;\n  transition: 300ms opacity;\n  width: 100%;\n"])), _ref => {
  var $loading = _ref.$loading;
  return $loading ? 0.5 : 1;
});
var VirtualListBox = (0, _styledComponents.default)(_ui.Box)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  height: 100%;\n  outline: none;\n  overflow-x: hidden;\n  overflow-y: auto;\n  width: 100%;\n"])));
var VirtualListChildBox = (0, _styledComponents.default)(_ui.Box)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  height: ", ";\n  position: relative;\n  width: 100%;\n"])), _ref2 => {
...
function SearchResults(_ref3) {
  ...
  var _useSearchState = (0, _search.useSearchState)(),
    ...
    debug = _useSearchState$state.debug,
    terms = _useSearchState$state.terms,
    result = _useSearchState$state.result;
  var childParentRef = (0, _react.useRef)(null);
  ...
  var handleResultClick = (0, _react.useCallback)(() => {
    ...
    if (recentSearchesStore) {
      var updatedRecentSearches = recentSearchesStore.addSearchTerm(terms);
      dispatch({
  ...
  var hasSearchResults = !!result.hits.length;
  return /*#__PURE__*/_react.default.createElement(SearchResultsFlex, {
    direction: "column"
  }, hasSearchResults && /*#__PURE__*/_react.default.createElement(_SortMenu.SortMenu, {
    small: small
  }), /*#__PURE__*/_react.default.createElement(SearchResultsInnerFlex, {
    $loading: result.loading,
    "aria-busy": result.loading,
    flex: 1
  }, result.error ? /*#__PURE__*/_react.default.createElement(_SearchError.SearchError, null) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, hasSearchResults &&
  /*#__PURE__*/
  // (Has search results)
