...
var OVERRIDABLE_FIELDS = __spreadArray(__spreadArray([], __read(DEFAULT_OVERRIDEABLE_FIELDS), false), ['rows'], false);
var TEXT_CORE = {
    name: 'text',
    title: 'Text',
    type: null,
...
export var TextType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(pick(TEXT_CORE, OVERRIDABLE_FIELDS), subTypeDef, {
            type: TEXT_CORE,
