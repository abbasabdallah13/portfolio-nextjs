...
function format(input, format) {
    return moment__default["default"](input).format(format);
}
function parse(dateString, format) {
    const parsed = moment__default["default"](dateString, format, true);
    if (parsed.isValid()) {
...
exports.parse = parse;
//# sourceMappingURL=legacyDateFormat.cjs.map
