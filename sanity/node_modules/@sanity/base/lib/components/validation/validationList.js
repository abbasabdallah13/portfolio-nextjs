...
function ValidationList(props) {
  ...
  }, hasErrors && errors.map((_error, i) => /*#__PURE__*/_react.default.createElement(_listItem.ListItem
  ...
  , {
    ...
    marker: _error,
    onClick: handleClick
  })), hasWarnings && warnings.map((_warning, i) => /*#__PURE__*/_react.default.createElement(_listItem.ListItem
  // eslint-disable-next-line react/no-array-index-key
  , {
    key: i,
    truncate: truncate,
    ...
    marker: _warning,
    onClick: handleClick
  })), hasInfo && info.map((_info, i) => /*#__PURE__*/_react.default.createElement(_listItem.ListItem
  // eslint-disable-next-line react/no-array-index-key
  , {
    key: i,
    truncate: truncate,
