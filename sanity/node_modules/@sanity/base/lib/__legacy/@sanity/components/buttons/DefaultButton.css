...
:root {
  ...
  --color-button-focus-shadow: 0 0 0 1px var(--component-bg), 0 0 0 3px var(--focus-color);
  ...
  --color-button-simple-enabled-text: color(var(--color-button-bg) lightness(- 10%));
  /* :focus */
  ...
  /* :hover */
  --color-button-simple-hover-bg: color(var(--color-button-bg) alpha(10%));
  --color-button-simple-hover-text: color(var(--color-button-bg) lightness(- 20%));
  /* :active */
  --color-button-simple-active-bg: color(var(--color-button-bg) alpha(20%));
  /* :selected */
  ...
  --color-button-navbar-simple-text: var(--main-navigation-color--inverted-muted);
  /* :focus */
  ...
  /* :selected */
  --color-button-navbar-simple-selected-bg: color(var(--selected-item-color) alpha(20%));
  --color-button-navbar-simple-selected-text: color(var(--selected-item-color) lightness(+ 15%));
  ...
  /* inverted={true} */
  --color-button-primary-inverted-border: color(var(--color-button-primary-bg) alpha(50%));
  ...
  --color-button-primary-simple-focus-text: color(var(--color-button-primary-bg) lightness(- 10%));
  /* :hover */
  --color-button-primary-simple-hover-bg: color(var(--color-button-primary-bg) alpha(10%));
  --color-button-primary-simple-hover-text: color(var(--color-button-primary-bg) lightness(- 20%));
  /* :active */
  --color-button-primary-simple-active-bg: color(var(--color-button-primary-bg) alpha(20%));
  /* :selected */
  ...
  /* inverted={true} */
  --color-button-success-inverted-border: color(var(--color-button-success-bg) alpha(50%));
  ...
  --color-button-success-simple-focus-text: color(var(--color-button-success-bg) lightness(- 10%));
  /* :hover */
  --color-button-success-simple-hover-bg: color(var(--color-button-success-bg) alpha(10%));
  --color-button-success-simple-hover-text: color(var(--color-button-success-bg) lightness(- 20%));
  /* :active */
  --color-button-success-simple-active-bg: color(var(--color-button-success-bg) alpha(20%));
  /* :selected */
  ...
  /* inverted={true} */
  --color-button-warning-inverted-border: color(var(--color-button-warning-bg) alpha(50%));
  ...
  --color-button-warning-simple-focus-text: color(var(--color-button-warning-bg) lightness(- 10%));
  /* :hover */
  --color-button-warning-simple-hover-bg: color(var(--color-button-warning-bg) alpha(10%));
  --color-button-warning-simple-hover-text: color(var(--color-button-warning-bg) lightness(- 20%));
  /* :active */
  --color-button-warning-simple-active-bg: color(var(--color-button-warning-bg) alpha(20%));
  /* :selected */
  ...
  /* inverted={true} */
  --color-button-danger-inverted-border: color(var(--color-button-danger-bg) alpha(50%));
  ...
  --color-button-danger-simple-enabled-text: color(var(--color-button-danger-bg) lightness(- 10%));
  /* :focus */
  ...
  /* :hover */
  --color-button-danger-simple-hover-bg: color(var(--color-button-danger-bg) alpha(10%));
  --color-button-danger-simple-hover-text: color(var(--color-button-danger-bg) lightness(- 20%));
  /* :active */
  --color-button-danger-simple-active-bg: color(var(--color-button-danger-bg) alpha(20%));
  /* :selected */
  ...
  /* :disabled */
  --color-button-disabled-bg: color(var(--component-bg) blend(var(--color-button-bg) 20%));
  --color-button-disabled-text: var(--color-button-bg);
  --color-button-simple-disabled-bg: transparent;
  --color-button-simple-disabled-text: var(--color-button-bg);
}
...
.root {
  ...
  @nest &:not(.disabled) {
    ...
    @nest &.simple[data-tone='navbar'] {
      @nest & > .inner {
        ...
        color: var(--color-button-navbar-simple-text);
      }
  ...
  @nest &.disabled {
    ...
    @nest &.simple > .inner {
      background-color: var(--color-button-simple-disabled-bg);
      color: var(--color-button-simple-disabled-text);
    }
  }
...
.groupContainer {
  ...
  @nest & .root:not(:last-child) {
    border-right: 1px solid color(var(--body-bg) alpha(30%));
  }
...
.icon {
  ...
  @nest & > svg {
    ...
    @nest &[data-sanity-icon='true'] {
      font-size: calc(25 / 16 * 1rem); /* 25px */
      margin: calc(4 / 16 * -1rem); /* -4px */
    }
  }
}
