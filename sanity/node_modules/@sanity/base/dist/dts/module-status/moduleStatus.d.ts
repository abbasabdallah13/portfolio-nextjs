 ...
 */
export declare function checkModuleStatus(options?: CheckModuleVersionsOptions): Observable<ModuleStatusResponse>;
/**
 ...
 * @internal Not a stable API yet
 */
export declare function getInstalledModuleVersion(moduleName: string): string | undefined;
