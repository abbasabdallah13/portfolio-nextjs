...
export declare function useDocumentPresence(documentId: any, { ignoreLastActiveUpdates }?: UseDocumentPresenceOptions): DocumentPresence[];
/**
 ...
 */
export declare function useDocumentPresenceUsers(documentId: any): User[];
