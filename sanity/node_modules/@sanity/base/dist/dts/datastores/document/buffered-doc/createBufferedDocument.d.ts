...
import { CommittedEvent, DocumentMutationEvent, DocumentRebaseEvent, SnapshotEvent, RemoteSnapshotEvent } from './types';
import { CommitRequest } from './createObservableBufferedDocument';
...
export declare const createBufferedDocument: (documentId: string, listenerEvent$: Observable<ListenerEvent>) => BufferedDocumentWrapper;
